...
import (
	...
	cpu "github.com/lribeiro/gopsutil/v3/cpu"
	"github.com/lribeiro/gopsutil/v3/internal/common"
	mem "github.com/lribeiro/gopsutil/v3/mem"
	net "github.com/lribeiro/gopsutil/v3/net"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	// see https://github.com/lribeiro/gopsutil/issues/596#issuecomment-432707831 for implementation details
	pid := p.Pid
