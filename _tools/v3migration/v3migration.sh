...
# usage: cd ${GOPATH}/src/github.com/lribeiro/gopsutil && bash tools/v3migration/v3migration.sh
...
###  change import path
find . -name "*.go" -print0 | xargs -0 -I@ sed -i 's|"github.com/lribeiro/gopsutil/|"github.com/lribeiro/gopsutil/v3/|g' @
